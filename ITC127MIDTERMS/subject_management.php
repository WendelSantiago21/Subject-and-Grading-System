...
<head>
    ...
    <title>Subject Page -  Subject Advising System</title>
...
<header>
    <nav class="topnav" id="mytopnav">
        <?php if ($Usertype === 'ADMINISTRATOR'): ?>
            ...
            <div class ="welcome">
                <div class="logo"></div>
            <h3 style="margin-right:390px;margin-top:33px" class="brand"><strong>Arellano University Subject Advising System</strong></h3>
            </div>
